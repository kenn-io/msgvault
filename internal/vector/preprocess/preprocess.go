...
// output for an unchanged Config (new regex, modified
...
// Config controls pre-embedding transformations.
//
...
func Preprocess(subject, body string, maxChars int, cfg Config) (string, bool) {
