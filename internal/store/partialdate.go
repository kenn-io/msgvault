...
// PartialDate is a calendar date with optional components in one of the five
// reduced or truncated forms accepted by ParsePartialDate. Nil means
// unspecified, never zero. Component storage is portable and indexable.
