...
func newIdentityScopeDuckDBFixture(t *testing.T) *query.DuckDBEngine {
	...
	tables := []struct {
		...
		{dir: "messages/year=2026", file: "messages.parquet", columns: "id, source_id, source_message_id, conversation_id, subject, snippet, sent_at, size_estimate, has_attachments, attachment_count, deleted_from_source_at, sender_id, owner_participant_id, message_type, is_from_me, year, month", values: `(1::BIGINT, 1::BIGINT, 'm1', 101::BIGINT, 'Alice', 'alpha', TIMESTAMP '2026-07-18 10:00:00', 100::BIGINT, true, 1::INTEGER, NULL::TIMESTAMP, NULL::BIGINT, NULL::BIGINT, 'email', false, 2026, 7), (2::BIGINT, 1::BIGINT, 'm2', 102::BIGINT, 'Bob', 'alpha', TIMESTAMP '2026-07-18 11:00:00', 200::BIGINT, true, 1::INTEGER, NULL::TIMESTAMP, NULL::BIGINT, NULL::BIGINT, 'email', false, 2026, 7)`},
