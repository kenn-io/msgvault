...
// 2.27.0 adds vector_text_enabled and vector_visual_enabled to authenticated
// health so clients can discover configured search lanes without archive stats.
