...
func TestMeetingIntelligenceOpenAPIContract(t *testing.T) {
	...
	assertions.Equal("2.28.0", APISchemaVersion)
	doc := OpenAPIDocument()
...
func TestOpenAPIMeetingImportContract(t *testing.T) {
	...
	assertions.Equal("2.28.0", APISchemaVersion, "meeting import is an additive schema release")
