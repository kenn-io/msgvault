...
func TestOpenAPISchemaVersionSavedViewRun(t *testing.T) {
	...
	assertions.Equal("2.23.0", APISchemaVersion)
	doc := OpenAPIDocument()
...
func TestOpenAPIMeetingImportContract(t *testing.T) {
	...
	assert.Equal("2.23.0", APISchemaVersion, "meeting import is an additive schema release")
