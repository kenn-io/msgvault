...
var settingsCatalog = []settingDefinition{
	...
	boolSetting("vector.multimodal.include_images", "search", func(c *config.Config) bool { return c.Vector.Multimodal.ImagesEnabled() }),
	boolSetting("vector.multimodal.include_animated_gifs", "search", func(c *config.Config) bool { return c.Vector.Multimodal.AnimatedGIFsEnabled() }),
	boolSetting("vector.multimodal.include_video", "search", func(c *config.Config) bool { return c.Vector.Multimodal.VideoEnabled() }),
	boolSetting("vector.multimodal.allow_image_queries", "search", func(c *config.Config) bool { return c.Vector.Multimodal.ImageQueriesEnabled() }),
