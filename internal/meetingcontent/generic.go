...
func decodeGeneric(fields map[string]jsontext.Value) Content {
...
func decodeGenericTranscript(fields map[string]jsontext.Value) Transcript {
	...
	if segmentsPresent {
		...
		for _, item := range items {
			var wire struct {
				...
				Offset  jsontext.Value `json:"offset_seconds"`
			}
...
func decodeGenericActions(fields map[string]jsontext.Value) ([]Action, Coverage, string) {
