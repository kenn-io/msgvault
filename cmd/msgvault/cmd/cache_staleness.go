...
func inspectCacheForQuery(ctx context.Context, dbPath, analyticsDir string, full, markerOnly bool) (cacheStaleness, error) {
	...
	defer release()
	return cacheNeedsBuildLockedWithOptions(dbPath, analyticsDir, full, markerOnly), nil
}
...
func cacheNeedsBuildLockedWithConversationHashes(dbPath, analyticsDir string, full bool) cacheStaleness {
	return cacheNeedsBuildLockedWithOptions(dbPath, analyticsDir, full, false)
}

func cacheNeedsBuildLockedWithOptions(dbPath, analyticsDir string, full, markerOnly bool) cacheStaleness {
