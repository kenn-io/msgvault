...
type DocumentVectorOperationsStatus struct {
	...
	ConfiguredEgressFingerprint string                          `json:"configured_egress_fingerprint" validate:"required"`
...
func (d DocumentVectorOperationsStatus) Validate() error {
	...
	if err := typesValidator.Var(d.ConfiguredEgressFingerprint, "required"); err != nil {
		errors = errors.Append("ConfiguredEgressFingerprint", err)
	}
	...
	if d.Consent != nil {
		if v, ok := any(d.Consent).(runtime.Validator); ok {
			if err := v.Validate(); err != nil {
				errors = errors.Append("Consent", err)
			}
		}
	}
	if d.Coverage != nil {
