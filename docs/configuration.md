...
| `min_rebuild_interval` | `0s` | Minimum age of a usable cache before a scheduled sync, manual sync, or query may queue an automatic rebuild. Queries serve the committed snapshot during the interval |
