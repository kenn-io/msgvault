...
export type SettingGroupID = 'browser' | 'server' | 'archive' | 'search' | 'sources' | 'integrations';
...
export const settingsCatalog: Record<string, CatalogEntry> = {
  ...
  'server.trusted_proxies': entry(
    'server',
    'Trusted proxies',
    'IP addresses or CIDR ranges allowed to supply forwarded HTTPS metadata.',
  ),
  'analytics.engine': entry('archive', 'Analytics engine', 'Engine used for aggregate queries.', {
    options: ['auto', 'sql', 'duckdb'],
  }),
  'analytics.auto_build_cache': entry(
    'archive',
    'Build stale cache automatically',
    'Build Parquet analytics before cached queries.',
  ),
  ...
  'vector.skip_extension_create': entry(
    'search',
    'Skip extension creation',
    'Use a vector extension installed by an administrator.',
  ),
  ...
  'vector.embeddings.api_key_env': entry(
    'search',
    'Embedding key environment variable',
    'Environment variable containing the endpoint key.',
  ),
  'vector.embeddings.model': entry('search', 'Embedding model', 'Model identifier used to build an index generation.'),
  'vector.embeddings.document_prefix': entry(
    'search',
    'Document task prefix',
    'Text prepended to every document chunk.',
  ),
  'vector.embeddings.query_prefix': entry(
    'search',
    'Query task prefix',
    'Text prepended to every vector search query.',
  ),
  ...
  'vector.embed.schedule.run_after_sync': entry(
    'search',
    'Embed after sync',
    'Run embedding after a successful source sync.',
  ),
  ...
  'vector.multimodal.enabled': entry(
    'search',
    'Visual attachment search',
    'Independently enable hosted visual attachment indexing.',
  ),
  'vector.multimodal.provider': entry(
    'search',
    'Visual embedding provider',
    'Provider used for visual attachment embeddings.',
    {
      options: ['voyage'],
    },
  ),
  'vector.multimodal.endpoint': entry(
    'search',
    'Visual embedding endpoint',
    'HTTPS API root used for multimodal embedding requests.',
  ),
  'vector.multimodal.api_key_env': entry(
    'search',
    'Visual embedding key environment variable',
    'Local environment variable containing the provider key.',
  ),
  'vector.multimodal.capabilities_file': entry(
    'search',
    'Visual capability manifest',
    'Path to the operator-probed Voyage capability manifest.',
  ),
  'vector.multimodal.model': entry(
    'search',
    'Visual embedding model',
    'Model identifier used for visual generations.',
    {
      options: ['voyage-multimodal-3.5'],
    },
  ),
  'vector.multimodal.dimension': entry(
    'search',
    'Visual embedding dimension',
    'Vector dimension required by the multimodal model.',
  ),
  'vector.multimodal.max_context_chars': entry(
    'search',
    'Maximum visual context characters',
    'Hard limit for normalized owning-message context.',
  ),
  'vector.multimodal.include_images': entry(
    'search',
    'Index still images',
    'Allow authoritative standalone still images to leave the machine for indexing.',
  ),
  'vector.multimodal.include_animated_gifs': entry(
    'search',
    'Index animated GIFs',
    'Allow animated GIFs only after provider capability is confirmed.',
  ),
  'vector.multimodal.include_video': entry(
    'search',
    'Index videos',
    'Allow bounded authoritative standalone videos to leave the machine for indexing.',
  ),
  'vector.multimodal.allow_image_queries': entry(
    'search',
    'Allow image queries',
    'Permit bounded query images to be sent to the visual embedding provider.',
  ),
  'vector.multimodal.scope.message_types': entry(
    'search',
    'Visual message types',
    'Optional message-type scope for visual indexing.',
  ),
  'vector.multimodal.schedule.cron': entry(
    'search',
    'Visual indexing schedule',
    'Cron schedule for background visual indexing.',
  ),
  'vector.multimodal.schedule.run_after_sync': entry(
    'search',
    'Index visuals after sync',
    'Run visual indexing after a successful source sync.',
  ),
  'vector.search.rrf_k': entry('search', 'RRF constant', 'Reciprocal rank fusion constant.'),
  'vector.search.k_per_signal': entry(
    'search',
    'Candidates per signal',
    'Candidate count contributed by each hybrid signal.',
  ),
  'vector.search.subject_boost': entry('search', 'Subject boost', 'Hybrid ranking weight for subject matches.'),
  'beeper.enabled': entry(
    'sources',
    'Desktop chat schedule enabled',
    'Enable scheduled imports from the supported desktop chat source.',
  ),
  'beeper.schedule': entry('sources', 'Desktop chat schedule', 'Cron schedule for the supported desktop chat source.'),
  'integrations.tasks.enabled': entry(
    'integrations',
    'Task integration',
    'Enable the provider-neutral task integration.',
  ),
  'integrations.tasks.endpoint': entry(
    'integrations',
    'Task endpoint',
    'HTTPS, loopback, Unix socket, or local discovery endpoint.',
  ),
  'integrations.tasks.api_key': entry(
    'integrations',
    'Task integration API key',
    'Bearer key used only by the daemon.',
    {
      secret: true,
    },
  ),
  'integrations.tasks.default_project': entry(
    'integrations',
    'Default task project',
    'Project used for task creation and lookup.',
  ),
};
