...
function person(): PersonSummary {
  return {
    ...
    activity_count: 42, meeting_count: 0, file_count: 3, source_counts: [{ source_type: 'gmail', count: 42 }],
...
function searchResult(): PersonSummary {
  return {
    ...
    activity_count: 7, meeting_count: 0, file_count: 0, source_counts: [], first_at: when, last_at: when, cache_revision: 'cache-rel'
  };
}
